...
export default function App(){
 ...
 return <div className="app-shell">
  <header className="topbar"><a className="brand" href="/" aria-label="SynexAgent 홈"><span className="brand-icon"><Activity size={24}/></span><span>Synex<span className="brand-light">Agent</span></span><span className="version">CLINICAL WORKSPACE</span></a><div className="top-meta"><span className="demo-label">{patient?patient.is_synthetic?'SYNTHETIC · 가상 환자':`FHIR · 실환자 (${patient.data_source})`:'—'}</span><span className="top-sep"/><span className="user-avatar">DR</span><span>의료진 검토 모드</span></div></header>
